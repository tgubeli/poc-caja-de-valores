...
public class Executor {
    ...
    private OrderApplication application = null;

    public Executor(SessionSettings settings) throws Exception {
        application = new OrderApplication(settings);
        ...
        log.info("Starting fix server, object created: " + acceptor);	
    ...
    public OrderApplication getApplication(){
